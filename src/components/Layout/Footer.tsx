    ...
    <footer className="relative mt-10 border-t border-border overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          "
        >
          I’m Shaikh Alhaj — a Full Stack Developer specializing in the MERN stack. I build high-performance, scalable web applications and digital products that solve real-world problems and deliver meaningful user experiences.
        </motion.p>
        ...
        >
          ...
          <motion.div variants={fadeUp} className="space-y-5">
            ...
            <a
              href="mailto:painteralhaj@gmail.com"
              className="
            ...
            >
              ...
              painteralhaj@gmail.com
            </a>
            <a
              href="https://wa.me/9737215041?text=Hello%20there"
              className="
                flex items-center gap-2 md:gap-3
                text-neutral-700
                hover:text-black
          ...
          <motion.div variants={fadeUp} className="space-y-5">
            ...
            <div className="flex flex-col gap-3 text-neutral-700">
              <a
                href="https://github.com/PainterAlhaj"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/alhaz-painter-b98452320"
                target="_blank"
                className="flex items-center gap-3 hover:text-black transition-colors"
                rel="noreferrer"
              >
        ...
        <motion.div
          ...
          "
        >
          <p>© {new Date().getFullYear()} Shaikh Alhaj</p>
